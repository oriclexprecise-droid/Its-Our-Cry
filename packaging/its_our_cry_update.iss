...
OutputDir=..\release
OutputBaseFilename=It-sOurCry-Update-V{#MyAppVersion}-Inno
...
[Files]
Source: "installer\inno_update_payload\app\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs ignoreversion
Source: "installer\inno_update_payload\app\config.yaml"; DestDir: "{app}"; Flags: onlyifdoesntexist
