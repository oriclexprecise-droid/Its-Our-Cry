...
$exclude = @('launcher.log', 'server.log', 'server.out.log', 'server.err.log', 'server_error.log', 'work', 'feedback', 'exports', 'output', 'outputs', 'logs', 'user_settings.json', 'user_models.json', 'model_aliases.json', 'ai_cache.json', 'ai_usage.json', 'reference_audio')
